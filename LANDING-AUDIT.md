...
- handover 词数过期：**该次审计时点**实际 应用层 **23**（写 20）、生态与前沿 **33**（写 32）、漏「训练方法」整节 6 词、总 **111** vs 107。（**2026-09-12 复算已为 118 词**，以 `web/words.json` 为准）
...
- 首页：6 层 / 111 胶囊 / 18 小节（**该次验证时点**；2026-09-12 复算为 **118 胶囊**）；`.deco` 1 组（2 blob + 2 星刺）；`tree-color` 0 命中；顶栏按钮文字为纯文字。
...
**视觉契约补齐**：新增 `DESIGN.md`（`design/19` 模板的 8 小节，含**来源分层**：品牌 override vs Semi 档位）与 `PRODUCT.md`；`README.md` 词数同步为 **当时** 111 / 23 / 33（2026-09-12 已随扩词更新为 118 / 25 / 36）。
